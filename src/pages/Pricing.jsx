  ...
  return (
    <div>
      <div style={{ padding: '52px 32px' }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text2)', marginBottom: 32, maxWidth: 520, lineHeight: 1.7 }}>
          Start free. Upgrade when the signals prove their value to you.
        </p>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 36 }}>
          ...
          <button onClick={() => setYearly(y => !y)} style={{ width: 44, height: 24, background: 'var(--navy)', borderRadius: 12, position: 'relative', cursor: 'pointer', border: 'none', flexShrink: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 20, maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ background: 'var(--white)', border: '1px solid var(--border2)', padding: '28px 24px' }}>
            ...
            <button style={{ background: 'transparent', color: 'var(--navy)', border: '1px solid var(--navy)', padding: '11px 20px', fontSize: 12, fontFamily: 'Source Sans 3, sans-serif', fontWeight: 600, cursor: 'pointer', width: '100%', letterSpacing: '.5px' }}>
              Get started free
            </button>
          </div>
          ...
          <div style={{ background: 'var(--gold-light)', border: '2px solid var(--gold2)', padding: '28px 24px' }}>
            ...
            <button style={{ background: 'var(--navy)', color: 'var(--gold3)', border: 'none', padding: '11px 20px', fontSize: 12, fontFamily: 'Source Sans 3, sans-serif', fontWeight: 600, cursor: 'pointer', width: '100%', letterSpacing: '.5px' }}>
        ...
        {/* Legal disclaimer */}
        <div style={{ marginTop: 40, padding: '20px 24px', background: 'var(--off)', border: '1px solid var(--border2)' }}>
          ...
          <p style={{ fontSize: 11, color: 'var(--text3)', lineHeight: 1.7 }}>
            HubGenius Finance provides market data and AI-generated signals for <strong>informational purposes only</strong>. This is <strong>not financial advice</strong>. Trading involves substantial risk of loss. Past performance does not guarantee future results. Never invest capital you cannot afford to lose. HubGenius Finance is not a registered investment adviser.{' '}
